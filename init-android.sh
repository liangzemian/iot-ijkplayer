...
function pull_fork()
{
    ...
    ./configure --enable-libLebConnection --enable-pic --enable-gpl --enable-nonfree --disable-doc --extra-cflags=-I/path/libLebConnection/include/ --extra-ldflags=-L/path/libLebConnection/lib/arm64 --extra-libs='-lLebConnection -lc++_shared'
